...
- optionally write a normalized data tab into the copied spreadsheet
...
- Keep any agent-written data in a clearly labeled helper tab unless the user asks for direct cell mapping into the reference layout.
