...
function Start-OAuthInitialization {
    ...
    @(
        ...
        "powershell -NoProfile -ExecutionPolicy Bypass -File '.claude/skills/drive-delivery/scripts/upload-approved-assets-to-drive.ps1' -InitializeOAuth -AuthCode '<PASTE_FULL_REDIRECT_URL_HERE>'",
        "",
