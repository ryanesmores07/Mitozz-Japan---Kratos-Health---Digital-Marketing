...
Use this path when you want to rehearse the workflow without spending Nano Banana tokens.

- Copy the prompt JSON and resolved image references manually into ChatGPT or Claude with image generation enabled.
- Paste one variant prompt at a time.
