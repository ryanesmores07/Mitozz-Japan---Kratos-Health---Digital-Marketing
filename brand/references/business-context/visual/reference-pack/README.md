...
Use this folder as the official image-reference source for Nano Banana generation.
...
- Rotate references by asset type so the feed stays cohesive without feeling repetitive.
